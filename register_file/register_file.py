...
def register_file(oa1, oa2, ia1, data_in, pc_in, pc_override, pc_alu, save_pc, eqsel):
    ...
    update_ia1 = mux2to1(data_in, pc_in, save_pc) # choose data_in or x0 depending on save_pc
